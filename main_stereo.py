...
def get_args_parser():
    ...
    parser.add_argument('--stage', default='middlebury', type=str,
    ...
    parser.add_argument('--resume', default="./pretained/gmstereo-scale1-resumeflowthings-sceneflow-16e38788.pth", type=str,
    ...
    parser.add_argument('--reg_refine', action='store_true',default=True,
                        help='optional task-specific local regression refinement')

    # model: parameter-free
    parser.add_argument('--attn_type', default='self_swin2d_cross_swin1d', type=str,
    ...
    parser.add_argument('--inference_size', default=[1024,1536], type=int, nargs='+')
    ...
    parser.add_argument('--val_freq', default=4000, type=int, help='validation frequency in terms of training steps')
    ...
    # inference
    # parser.add_argument('--inference_dir', default="demo/stereo-middlebury", type=str)
...
def main(args):
    ...
    while total_steps < args.num_steps:
        ...
        for i, sample in enumerate(train_loader):
            ...
            img = torch.stack([left, right])
            mask = (gt_disp > 0) & (gt_disp < args.max_disp)

            if not mask.any():
                continue

            pred_disps = model(img,
                               attn_type=args.attn_type,
                               attn_splits_list=args.attn_splits_list,
                               corr_radius_list=args.corr_radius_list,
                               prop_radius_list=args.prop_radius_list,
